#!/usr/bin/env bash
# cuda_vs_cpu_bench.sh — Compare CUDA GPU vs CPU builds of MUSIC (2D boost-invariant).
#
# Run from the MUSIC repository root:
#   OMP_NUM_THREADS=$(nproc) bash tests/cuda_vs_cpu_bench.sh
#
# Prerequisites:
...
echo "========================================================"
echo " MUSIC CUDA GPU vs CPU benchmark (2D boost-invariant)"
echo " $(date)"
echo "========================================================"
